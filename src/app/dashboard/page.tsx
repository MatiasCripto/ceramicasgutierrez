...
export default async function DashboardPage() {
  ...
  const ventasMes = (currentSales.data ?? []).reduce((s: number, o: any) => s + Number(o.total_price ?? 0), 0)
  const ventasPrev = (prevSales.data ?? []).reduce((s: number, o: any) => s + Number(o.total_price ?? 0), 0)
