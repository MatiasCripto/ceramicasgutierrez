              ...
              <article key={bundle.id} className="group bg-white/70 backdrop-blur-sm border border-sand-beige/40 rounded-sm overflow-hidden transition-all duration-500 hover:shadow-xl hover:shadow-sand-beige/20 hover:-translate-y-1">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 border border-charcoal-soft/20 text-charcoal-soft text-xs tracking-[0.1em] uppercase font-light rounded-sm hover:bg-charcoal-soft hover:text-warm-ivory transition-all duration-500 group/btn"
                  >
